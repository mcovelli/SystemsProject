...
if (isset($_POST['updateCourseSection'])) {
    ...
    $cnt = (int)($fac_count['cnt'] ?? 0);
    $max = (int)($fac_count['maxAllowed'] ?? 0);
...
<?php $nu_page = 'Update Course Sections'; $nu_crumb = ['createDirectory.php', '← Back to Directory']; $nu_bell = false; require __DIR__ . '/partials/header.php'; ?>
