...
switch ($majorOrMinor){
    case 'major':
        $sql = "UPDATE Major SET DeptID = (SELECT DeptID FROM Department WHERE DeptName = ?), MajorName = ?, CreditsNeeded = ? WHERE MajorID = ?";
        $stmt = $mysqli->prepare($sql);
        $stmt->bind_param("ssis", $DeptId, $majorName, $majorCreditsNeeded, $majorID);
    ...
    case("minor"):
        $sql = "UPDATE Minor SET DeptID = (SELECT DeptID FROM Department WHERE DeptName = ?), MinorName = ?, CreditsNeeded = ? WHERE MinorID = ?";
            $stmt = $mysqli->prepare($sql);
            $stmt->bind_param("ssis", $DeptId, $minorName, $minorCreditsNeeded, $minorID);
            ...
            <div class="card-head between">
                ...
                <div id = "create-section-majorminor">
                    <form id = "CreateMajorMinor" method = "POST" action = "">
                        ...
                        <select id="majorOrMinor" name="majorOrMinor">
