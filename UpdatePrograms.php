...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $mysqli->begin_transaction();
       ...
       $sql= "UPDATE Program
            SET ProgramCode = ?, ProgramName = ?, DegreeLevel = ?, DeptID = ?, CreditsRequired = ?, Status = ?
            WHERE ProgramID = ?";
...
<body>
  <header class="topbar">
    <div class="brand">
      ...
      <span class="pill">Update Programs</span>
    </div>
    ...
    <main>
        ...
        <section>
          ...
          <form id="UpdateProgram" method="POST" action="">
            ...
            <input type = "hidden" select id="program_id" name="program_id"><br>

            <label for="program_code">Program Code:</label>
            <input type = "text" select id="program_code" name="program_code"><br>

            <label for="program_name">Program Name:</label>
            <input type = "text" select id="program_name" name="program_name"><br>
            ...
            <input type="number" id="req_cred_num" name="req_cred_num"><br>

            <label for="status">Program Status:</label>
            <input type="text" id="prog_stat" name="prog_stat"><br>
...
<footer class="footer">© 2025 Northport University • All rights reserved</footer>
 ...
 <script src="https://unpkg.com/lucide@latest/dist/umd/lucide.js"></script>
  <script>
    ...
    document.getElementById("UpdateProgram").addEventListener("submit", (e) => {
