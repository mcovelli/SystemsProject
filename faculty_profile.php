...
$courses_sql = "
  SELECT cs.CRN, c.CourseName, d.DayOfWeek, p.StartTime, p.EndTime, cs.RoomID
    ...
    <div class="wrap grid">
      ...
      <section class="card">
              ...
              <?php else: ?>
                <?php foreach ($courses as $c): ?>
                  <tr>
                    ...
                    <td><?php echo htmlspecialchars($c['DayOfWeek']); ?></td>
        ...
        <div class="section">
          ...
          <div class="pub">Publication information not available.</div>
        </div>
