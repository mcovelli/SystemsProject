  ...
  <header class="topbar">
    ...
    <div class="top-actions">
      ...
      <div class="user">
        ...
        <div class="user-meta">
          <div class="name">Michael B.</div>
          <div class="sub">CS • Class of 2026</div>
        </div>
    ...
    <section class="left">
      <div class="stats">
        <div class="card stat">
          ...
          <div class="sub muted">Up 0.06 from last term</div>
        </div>
        ...
        <div class="card stat">
          ...
          <div class="sub muted">45/120 completed</div>
        </div>
    ...
    <aside class="right">
      ...
      <div class="grid-two sm-one">
        <div class="card">
          ...
          <div id="studentMsgList" class="vstack gap"></div>
          <div class="pt-8">
